    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#04343a] shadow rounded-lg p-4 md:p-6 overflow-x-auto">
        ...
        <div className="md:hidden space-y-4">
          {jobs.map((job) => (
            <div key={job._id} className="bg-white/10 p-4 rounded-lg shadow">
              <h3 className="text-lg font-semibold text-white mb-2">{job?.jobName}</h3>
              ...
              <p className="text-sm text-gray-200">
                <span className="font-semibold">Applicants:</span> {job?.appliedUsers?.length || 0}
              </p>
        ...
        {openEditForm && selectedJob && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[95%] max-w-4xl rounded-2xl border border-green-600 bg-white shadow-2xl overflow-hidden"
            >
              ...
              <div className="max-h-[80vh] overflow-y-auto p-4">
                <EditJob job={selectedJob} closeModal={() => setOpenEditForm(false)} hotUpdate={hotUpdate} />
              </div>
            </motion.div>
          </>
        )}
