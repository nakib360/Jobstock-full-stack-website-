...
const EditJob = ({ job, closeModal, hotUpdate }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .put(`${import.meta.env.VITE_API}/jobs/${job?._id}`, { formData }, { withCredentials: true })
      .then((res) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white px-4 sm:px-6 md:px-8 pt-0 py-6 shadow-lg rounded-xl">
      <h2 className="text-2xl font-bold mb-6 text-green-600 text-center md:text-left">Edit Job</h2>
